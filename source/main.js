...
const handleStartGame = function (event) {
  event.preventDefault(); // prevents the default events on html to happen
  if (game !== null && game.isPlaying) {
//checks if the game started, prevents double object start of the game if the space is pressed
    return;
  }
  game = new Game(
    maxGameTime,
